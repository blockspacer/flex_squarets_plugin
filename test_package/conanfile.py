...
class TestPackageConan(ConanFile):
    ...
    def test(self):
        if not tools.cross_building(self.settings):
            ...
            #
            flex_squarets_plugin_ROOT = self.deps_cpp_info["flex_squarets_plugin"].rootpath
            flex_squarets_plugin_file = flex_squarets_plugin_ROOT
            flex_squarets_plugin_file = os.path.join(flex_squarets_plugin_file, "lib")
            flex_squarets_plugin_file = os.path.join(flex_squarets_plugin_file, "flex_squarets_plugin" + ext)
            self.output.info('flex_squarets_plugin_file = %s' % (flex_squarets_plugin_file))
            #
            ...
            flextool_cmd = os.environ['flextool_BIN'] \
              ...
              " --extra-arg=-I{}" \
              " {}/main.cpp".format(
              flex_reflect_plugin_file, flex_squarets_plugin_file, cling_includes, clang_includes, self.source_folder)
